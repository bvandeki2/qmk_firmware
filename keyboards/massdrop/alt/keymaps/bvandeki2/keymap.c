...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [3] = LAYOUT_65_ansi_blocker(
        ...
        _______, UC(0x0397), _______,    UC(0x0395), UC(0x03A6), UC(0x03A4), _______,    UC(0x03AC), _______, UC(0x0390), UC(0x0396), _______, _______, _______, _______, \
        _______, UC(0x0391), UC(0x03A3), UC(0x0394), _______,    UC(0x0393), UC(0x0398), _______,    _______, UC(0x03AB), _______,    _______,          _______, _______, \
